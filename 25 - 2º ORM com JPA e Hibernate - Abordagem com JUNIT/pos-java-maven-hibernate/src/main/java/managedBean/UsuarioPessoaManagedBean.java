...
public class UsuarioPessoaManagedBean {
	...
	/*
	 * private DaoGeneric<UsuarioPessoa> daoGeneric = new
	 * DaoGeneric<UsuarioPessoa>();
	 */
	...
	private void montarGrafico() {
		...
		barChartModel.addSeries(userSalario); /* add grupo */
	...
	public void addEmail() {
		...
		FacesContext.getCurrentInstance().addMessage(null,
				new FacesMessage(FacesMessage.SEVERITY_INFO, "Informação: ", "Email salvo com sucesso!"));
